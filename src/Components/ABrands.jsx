...
<div data-aos="zoom-out-up"  data-aos-easing="linear"
     data-aos-duration="1200" onClick={()=>handlebrand(brand)}  className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
